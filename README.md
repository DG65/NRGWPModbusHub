...
- **IDM Energiesysteme** (Navigatorregelung 2.0, z. B. ALM-Serie) — Registerkarte direkt aus IDMs eigenem PDF „Modbus TCP Navigatorregelung 2.0", an einer laufenden ALM bestätigt (Außen-, Vorlauf-, Rücklauf-, Speicher-, Heizkreistemperatur, Warmwasser-Soll; Warmwasser-Ist ist der Speicherfühler oben). Einziger Hersteller dieser Liste mit 32-Bit-Fließkommawerten statt Ganzzahl×Faktor.
